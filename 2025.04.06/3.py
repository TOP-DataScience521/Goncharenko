...
#     Согласно правилам русского языка о согласовании составных количественных числительных и существительных, возможны три варианта согласования. Поэтому кортеж, передаваемый вторым аргументом,
#  должен содержать ровно три объекта str.
...
def countable_nouns (num, param: tuple[str,str,str])-> str:

    last_num = num % 10
    if 11 <= num % 100 <= 14 or last_num in (5,6,7,8,9,0):
        return param[2]
    elif 2 <= last_num <= 4:
        return param[1]
    else:
...
print(countable_nouns(41, ("год", "года", "лет")))
# год
# print(countable_nouns(0, ("год", "года", "лет")))
# лет
# print(countable_nouns(23, ("год", "года", "лет")))
# года